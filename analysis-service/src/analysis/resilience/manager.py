"""
Comprehensive resilience manager for analysis service.
...
from .factory import AnalysisResilienceFactory
from .fallback import AnalysisFallbackManager, FallbackConfig
...
class ComprehensiveResilienceManager:
    ...
    for analysis service operations.
    """
    ...
    def __init__(self, metrics_collector: Optional[Any] = None):
        ...
        self._fallback_managers: Dict[str, AnalysisFallbackManager] = {}
    ...
    def create_fallback_manager(
        ...
        fallback_manager = AnalysisFallbackManager(
            name=name,
            config=config,
            metrics_collector=self._metrics_collector,
        )
    ...
    def get_fallback_manager(self, name: str) -> Optional[AnalysisFallbackManager]:
