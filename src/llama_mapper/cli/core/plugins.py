...
class PluginManager:
    ...
    def load_plugins_from_directory(self, directory: Optional[Union[str, Path]] = None) -> None:
        ...
        if hasattr(module, "register"):
            ...
            if callable(register_func):
                try:
                    ...
                    print(f"Warning: Plugin {plugin_name} register function failed: {e}")
...
class PluginInterface:
    ...
    def create_command_decorator(
        ...
        **click_options: Any,
        ...
        from .base import command_decorator, async_command_decorator
