...
try:
    ...
    # Minimal stubs to allow import without peft installed during import-time tests
...
class LoRATrainingConfig:
    ...
    def to_training_arguments(self) -> TrainingArguments:
        ...
        return TrainingArguments(
            ...
            eval_strategy="steps",  # transformers>=4.56 uses eval_strategy
            save_strategy="steps",
...
class LoRATrainer:
    ...
    def evaluate(
        self, eval_dataset: Optional[MapperDataset] = None
    ) -> Dict[str, float]:
        """
...
class MapperTrainer(Trainer):
    ...
    def __init__(self, metrics_collector: LoRATrainer, *args: Any, **kwargs: Any):
