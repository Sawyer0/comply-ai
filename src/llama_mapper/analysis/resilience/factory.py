...
class ResilienceFactory:
    ...
    def create_resilience_stack(
        ...
        logger.info(f"Resilience stack created for service '{service_name}'")
...
class ResilienceManager:
    ...
    def create_retry_manager(
        ...
        if name in self._retry_managers:
            logger.warning(f"Retry manager '{name}' already exists, returning existing instance")
        ...
        logger.info(f"Retry manager '{name}' created")
