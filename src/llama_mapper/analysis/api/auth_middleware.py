...
from ..infrastructure.auth import APIKeyManager, APIKeyScope, APIKeyStatus
...
class APIKeyAuthMiddleware(BaseHTTPMiddleware):
    ...
    def _check_rate_limit(self, api_key, request: Request) -> bool:
        ...
        self._rate_limit_storage = {
            k: v for k, v in self._rate_limit_storage.items()
...
class APIKeyAuthDependency:
    ...
    def __init__(self, api_key_manager: APIKeyManager, required_scopes: Optional[Set[APIKeyScope]] = None):
        """
