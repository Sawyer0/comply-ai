...
class TestQualityMonitor:
    ...
    def test_record_metric(self):
        ...
        assert (
            monitor._current_metrics[QualityMetricType.SCHEMA_VALIDATION_RATE] == 0.95
        )
    ...
    def test_get_metric_statistics(self):
        ...
        stats = monitor.get_metric_statistics(
            QualityMetricType.SCHEMA_VALIDATION_RATE, time_window_minutes=10
        )
...
class TestQualityDegradationDetector:
    ...
    def test_detector_initialization(self):
        ...
        detector = QualityDegradationDetector(
            anomaly_sensitivity=2.5, trend_window_minutes=45
        )
    ...
    def test_detect_sudden_drop(self):
        ...
        assert degradation.severity in [
    ...
    def test_detect_anomalies(self):
        ...
        anomalies = detector.detect_anomalies(
            QualityMetricType.SCHEMA_VALIDATION_RATE, metrics
        )
...
class TestAlertHandlers:
    ...
    def test_logging_alert_handler(self):
        ...
        with patch(
            "src.llama_mapper.analysis.quality.alerting.alert_handlers.logger"
        ) as mock_logger:
    ...
    def test_slack_alert_handler(self, mock_post):
        ...
        handler = SlackAlertHandler(
            webhook_url="https://hooks.slack.com/test", channel="#test"
        )
...
class TestQualityAlertingSystem:
    ...
    def test_system_initialization(self):
        ...
        system = QualityAlertingSystem(
            monitoring_interval_seconds=30, max_metrics_per_type=1000
        )
