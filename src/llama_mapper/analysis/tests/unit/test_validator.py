...
from ...validation.evidence_refs import validate_evidence_refs, ALLOWED_EVIDENCE_REFS
...
class TestAnalysisValidator:
    ...
    def test_validate_and_fallback_valid_output(self, validator, sample_request):
        ...
        with patch.object(validator.json_validator, 'validate', return_value=(True, [])):
    ...
    def test_validate_and_fallback_invalid_output(self, validator, sample_request):
        ...
        with patch.object(validator.json_validator, 'validate', return_value=(False, ["Missing required field: opa_diff"])):
    ...
    def test_validate_and_fallback_exception(self, validator, sample_request):
        ...
        with patch.object(validator.json_validator, 'validate', side_effect=Exception("Validation error")):
            result = validator.validate_and_fallback(invalid_output, sample_request)
...
class TestEvidenceRefsValidation:
    ...
    def test_allowed_evidence_refs_constant(self):
        ...
        expected_fields = {
            "period", "tenant", "app", "route", "required_detectors",
            "observed_coverage", "required_coverage", "detector_errors",
            "high_sev_hits", "false_positive_bands", "policy_bundle", "env"
        }
    ...
    def test_validate_evidence_refs_valid(self):
        ...
        valid_refs = ["detector1", "detector2", "observed_coverage", "required_coverage"]
    ...
    def test_validate_evidence_refs_against_input_valid(self):
        ...
        is_valid, errors = validate_evidence_refs_against_input(evidence_refs, input_data)
