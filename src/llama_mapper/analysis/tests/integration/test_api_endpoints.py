...
class TestAnalysisAPIEndpoints:
    ...
    def test_analyze_endpoint_success(self, client, sample_request_data):
        ...
        with patch('src.llama_mapper.analysis.api.dependencies.get_analysis_service') as mock_service:
    ...
    def test_batch_analyze_endpoint_success(self, client, sample_request_data):
        ...
        with patch('src.llama_mapper.analysis.api.dependencies.get_batch_analysis_service') as mock_service:
    ...
    def test_batch_analyze_endpoint_too_many_requests(self, client, sample_request_data):
    ...
    def test_batch_analyze_endpoint_service_error(self, client, sample_request_data):
        ...
        with patch('src.llama_mapper.analysis.api.dependencies.get_batch_analysis_service') as mock_service:
            # Mock service to raise exception
            mock_batch_service = Mock()
            mock_batch_service.analyze_batch.side_effect = Exception("Batch service error")
            mock_service.return_value = mock_batch_service
