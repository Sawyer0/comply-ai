...
class AnalysisApplicationService:
    ...
    async def analyze_metrics(self, request_dto: AnalysisRequestDTO) -> AnalysisResponseDTO:
        """
        ...
        try:
            ...
            logger.error(f"Analysis application service error: {e}")
            raise
    ...
    async def batch_analyze_metrics(
        ...
        """
        try:
            return await self.batch_analyze_metrics_use_case.execute(request_dto, idempotency_key)
        except Exception as e:
            logger.error(f"Batch analysis application service error: {e}")
            raise
    ...
    async def evaluate_quality(
        ...
        try:
            ...
            for req_dto, resp_dto in examples:
                domain_examples.append((req_dto.to_domain_entity(), resp_dto.to_domain_entity()))
            
            return await self.quality_evaluation_use_case.evaluate_quality(domain_examples)
        except Exception as e:
            logger.error(f"Quality evaluation application service error: {e}")
            raise
    ...
    def calculate_drift(self, recent_outputs: List[AnalysisResponseDTO]) -> float:
        ...
        try:
            ...
            domain_outputs = [resp_dto.to_domain_entity() for resp_dto in recent_outputs]
            return self.quality_evaluation_use_case.calculate_drift(domain_outputs)
        except Exception as e:
            logger.error(f"Drift calculation application service error: {e}")
            raise
    ...
    def get_evaluation_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Evaluation summary application service error: {e}")
            raise
    ...
    async def cleanup_cache(self) -> int:
        ...
        try:
            ...
            logger.error(f"Cache cleanup application service error: {e}")
            raise
    ...
    async def health_check(self) -> HealthCheckDTO:
        ...
        try:
            ...
            logger.error(f"Health check application service error: {e}")
            raise
...
class BatchAnalysisApplicationService:
    ...
    async def process_batch(
        ...
        try:
            ...
            logger.error(f"Batch processing application service error: {e}")
            raise
    ...
    async def cleanup_batch_cache(self) -> int:
        ...
        try:
            ...
            logger.error(f"Batch cache cleanup application service error: {e}")
            raise
