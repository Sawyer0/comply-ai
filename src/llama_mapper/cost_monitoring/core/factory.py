...
from .interfaces import ResourceMonitor, CostCalculator, MetricsStorage, AlertManager, ScalingExecutor
from .resource_monitor import SystemResourceMonitor, MockResourceMonitor, ApplicationMetricsMonitor
...
class CostMonitoringFactory:
    ...
    def create_resource_monitor(
        ...
        if monitor_type == "system":
            ...
            base_monitor = CostMonitoringFactory.create_resource_monitor("system", include_gpu)
    ...
    def create_cost_calculator(
        ...
        cost_per_unit: Optional[dict] = None
    ) -> CostCalculator:
