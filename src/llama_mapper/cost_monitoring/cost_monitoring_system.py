...
from .guardrails import CostGuardrails, CostGuardrailsConfig, CostGuardrail
...
class CostMonitoringSystem:
    ...
    def _create_metrics_collector(self) -> CostMetricsCollector:
        ...
        resource_monitor = CostMonitoringFactory.create_resource_monitor(
            monitor_type="system",  # Use system monitor in production
            include_gpu=True
        )
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "uptime_seconds": (
                ...
                if self._startup_time and self._running else 0
            ),
            "components": {
                "metrics_collector": {
    ...
    def get_scaling_policies(self, tenant_id: Optional[str] = None) -> List[ScalingPolicy]:
    ...
    def get_cost_breakdown(
        ...
        return self.metrics_collector.get_cost_breakdown(start_time, end_time, tenant_id)
    ...
    def get_optimization_recommendations(
        ...
        return self.analytics.get_optimization_recommendations(category, priority_min, tenant_id)
