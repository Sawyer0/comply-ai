...
class TestCostAwareScaler:
    ...
    def test_is_in_cooldown(self, scaler):
        ...
        # Old scaling
        scaler._last_scaling_times["test_policy"] = datetime.now(timezone.utc) - timedelta(hours=2)
        assert not scaler._is_in_cooldown(policy)
    ...
    def test_calculate_decision_score(self, scaler):
        ...
        score = scaler._calculate_decision_score(decision, current_cost, current_performance)
