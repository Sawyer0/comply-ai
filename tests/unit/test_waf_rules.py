...
from src.llama_mapper.analysis.security.waf.engine.rule_engine import (
    WAFRule,
    WAFRuleEngine,
)
...
class TestWAFRuleEngine:
    ...
    def test_scan_sql_injection_request(self, waf_engine):
        ...
        sql_violations = [
            v for v in violations if v.violation_type == AttackType.SQL_INJECTION
        ]
    ...
    def test_scan_path_traversal_request(self, waf_engine):
        ...
        path_violations = [
            v for v in violations if v.violation_type == AttackType.PATH_TRAVERSAL
        ]
    ...
    def test_scan_command_injection_request(self, waf_engine):
        ...
        cmd_violations = [
            v for v in violations if v.violation_type == AttackType.COMMAND_INJECTION
        ]
    ...
    def test_scan_ldap_injection_request(self, waf_engine):
        ...
        ldap_violations = [
            v for v in violations if v.violation_type == AttackType.LDAP_INJECTION
        ]
...
class TestWAFIntegration:
    ...
    def test_comprehensive_attack_detection(self):
        ...
        malicious_request = {
            ...
            "query_params": {"id": "1' OR '1'='1", "filter": "(uid=*)(|(password=*))"},
    ...
    def test_false_positive_prevention(self):
        ...
        for request in legitimate_requests:
            ...
            assert (
                len(high_severity_violations) == 0
            ), f"High severity violation in legitimate request: {violations}"
