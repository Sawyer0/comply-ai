...
from src.llama_mapper.analysis.security.waf.middleware.waf_middleware import (
    WAFMiddleware,
)
...
class TestWAFMiddleware:
    ...
    def test_xss_request_blocked(self, test_app):
        ...
        response = client.post(
            "/api/users", json={"name": "<script>alert('xss')</script>"}
        )
    ...
    def test_command_injection_request_blocked(self, test_app):
        ...
        response = client.post("/api/users", json={"command": "ls; cat /etc/passwd"})
    ...
    def test_ldap_injection_request_blocked(self, test_app):
        ...
        response = client.post("/api/users", json={"filter": "(uid=*)(|(password=*))"})
...
class TestWAFMiddlewareIntegration:
    ...
    def test_analysis_api_protection(self):
        ...
        malicious_batch = {"requests": [safe_request, malicious_request]}
