...
from src.llama_mapper.analysis.resilience.config.circuit_breaker_config import CircuitBreakerConfig
from src.llama_mapper.analysis.resilience.interfaces import (
...
class TestCircuitBreakerConfig:
    ...
    def test_circuit_breaker_config_validation(self):
        ...
        with pytest.raises(ValueError, match="failure_threshold must be between 1 and 20"):
        ...
        with pytest.raises(ValueError, match="recovery_timeout must be between 10.0 and 300.0"):
