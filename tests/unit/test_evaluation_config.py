...
class TestWeeklyEvaluationConfig:
    ...
    def test_custom_config(self):
        ...
        config = WeeklyEvaluationConfig(
            ...
            storage=StorageConfig(backend_type="database", database_url="postgresql://localhost/db")
        )
...
class TestConfigurationLoading:
    ...
    def test_from_environment(self):
        ...
        with patch.dict(os.environ, env_vars):
            ...
            assert config.default_schedule == '0 10 * * 2'
            assert config.thresholds.schema_valid_rate == 0.99
            assert config.notifications.email_recipients == ['admin@example.com', 'team@example.com']
