...
class TestStorageManager:
    ...
    async def test_initialization_clickhouse(self, storage_config):
        ...
        with patch('boto3.Session') as mock_session, \
             ...
             patch.object(StorageManager, '_create_clickhouse_tables') as mock_create_tables:
    ...
    async def test_worm_policy_setup(self, settings):
        ...
        with patch('boto3.Session') as mock_session, \
            ...
            mock_s3_client = MagicMock()
            mock_s3_client.head_bucket.return_value = None
            mock_s3_client.get_object_lock_configuration.side_effect = Exception("ObjectLockConfigurationNotFoundError")
