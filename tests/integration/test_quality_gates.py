...
class TestQualityGateValidator:
    ...
    def test_load_golden_test_cases_empty_file(self):
        ...
        validator = QualityGateValidator(golden_test_cases_path=Path("nonexistent.json"))
    ...
    async def test_run_golden_test_cases_success(self):
        ...
        mock_model_server.generate_mapping = AsyncMock(return_value='{"taxonomy": ["TEST.Category"], "scores": {"TEST.Category": 0.95}, "confidence": 0.95}')
        ...
        # Check results
        schema_results = [r for r in results if r.metric_name == "schema_valid_percentage"]
    ...
    async def test_validate_all_quality_gates(self):
        ...
        try:
            ...
            test_results = [r for r in results if r.metric_name in ["schema_valid_percentage", "golden_test_pass_rate"]]
    ...
    def test_create_sample_golden_test_cases(self):
        ...
        try:
            ...
            required_fields = ["detector", "input_output", "expected_taxonomy", "expected_confidence_min", "description", "category"]
