...
class TestAnalysisAPI:
    ...
    def client(self):
        """Create test client."""
        with patch(
            "src.llama_mapper.analysis.config.settings.AnalysisSettings"
        ) as mock_settings:
    ...
    def test_analyze_batch_endpoint(self, client, sample_request):
        ...
        batch_request = {"requests": [sample_request, sample_request]}
    ...
    def test_analyze_batch_endpoint_missing_idempotency_key(
        self, client, sample_request
    ):
        """Test batch analysis endpoint with missing idempotency key."""
        batch_request = {"requests": [sample_request]}
    ...
    def test_analyze_batch_endpoint_too_many_requests(self, client, sample_request):
        ...
        batch_request = {"requests": [sample_request] * 101}  # Exceeds limit of 100
...
class TestAnalysisModuleIntegration:
    ...
    def test_model_server_integration(self):
        ...
        from src.llama_mapper.analysis.infrastructure.template_provider import (
    ...
    def test_security_integration(self):
        ...
        from src.llama_mapper.analysis.infrastructure.security import (
    ...
    def test_opa_integration(self):
        ...
        from src.llama_mapper.analysis.infrastructure.opa_generator import (
            OPAPolicyGenerator,
        )
        ...
        policy = opa_generator.generate_coverage_policy(
            ["pii", "jailbreak"], {"pii": 0.95, "jailbreak": 0.95}
        )
    ...
    def test_quality_evaluation_integration(self):
        ...
        from src.llama_mapper.analysis.domain.entities import (
            AnalysisRequest,
            AnalysisResponse,
            VersionInfo,
        )
        from src.llama_mapper.analysis.infrastructure.quality_evaluator import (
            QualityEvaluator,
        )
