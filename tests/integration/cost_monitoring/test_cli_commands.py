...
class TestCostMonitoringCLICommands:
    ...
    def mock_cost_system(self):
        ...
        cost_system.health_check = AsyncMock(return_value={
    ...
    @pytest.mark.asyncio
    async def test_cost_recommendations_command(self, mock_config_manager, mock_cost_system):
        """Test cost recommendations command."""
        from src.llama_mapper.cost_monitoring.analytics.cost_analytics import CostOptimizationRecommendation
    ...
    async def test_cost_anomalies_command(self, mock_config_manager, mock_cost_system):
        ...
        from src.llama_mapper.cost_monitoring.analytics.cost_analytics import CostAnomaly
    ...
    async def test_cost_forecast_command(self, mock_config_manager, mock_cost_system):
        ...
        from src.llama_mapper.cost_monitoring.analytics.cost_analytics import CostForecast
...
class TestCostMonitoringCLIIntegration:
    ...
    def test_cli_command_registration(self):
        ...
        expected_commands = ["status", "breakdown", "trends", "recommendations", "anomalies", "forecast"]
