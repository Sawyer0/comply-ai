...
def main():
    ...
    try:
        ...
        jailbreak_examples = generator.generate_synthetic_jailbreak_examples(num_examples=10)
        ...
        if jailbreak_examples:
            ...
            print(f"Instruction: {example.instruction}")
            print(f"Response: {example.response}")
            print(f"Synthetic prompt: {example.metadata.get('synthetic_prompt', 'N/A')}")
        
        # Test prompt injection generation
        print("\nGenerating synthetic prompt injection examples...")
        injection_examples = generator.generate_synthetic_prompt_injection_examples(num_examples=15)
