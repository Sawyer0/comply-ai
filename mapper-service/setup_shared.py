#!/usr/bin/env python3
"""
Setup script to configure shared components integration for mapper service.

This script ensures the shared directory is properly configured and accessible
to the mapper service.
"""
...
def setup_shared_integration():
    ...
    print(f"Setting up shared integration...")
    ...
    expected_dirs = ["interfaces", "utils", "exceptions", "models"]
    missing_dirs = []
    ...
    if site_packages.exists():
        pth_file = site_packages / "mapper-shared.pth"
        try:
    ...
    mapper_src = current_dir / "src" / "mapper"
    shared_link = mapper_src / "shared_lib"
    ...
    print("Shared integration setup complete!")
    return True
