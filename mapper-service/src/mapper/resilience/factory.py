"""
Resilience factory for creating and configuring mapper service resilience components.

This module provides factory methods for creating resilience components
with proper configuration and dependency injection specific to mapper operations.
"""
...
class MapperResilienceFactory:
    """Factory for creating mapper service resilience components."""
    ...
    def create_resilience_stack(
        ...
        logger.info("Mapper resilience stack created for service '%s'", service_name)
        return circuit_breaker, retry_manager


class MapperResilienceManager(IResilienceManager):
    """
    Manager for multiple mapper service resilience components.

    Provides centralized management and monitoring of resilience components
    across different mapper operations and components.
    """
    ...
    def __init__(self, metrics_collector: Optional[Any] = None):
        ...
        logger.info("Mapper resilience manager initialized")
    ...
    def create_circuit_breaker(
        ...
        logger.info("Mapper circuit breaker '%s' created", name)
    ...
    def create_retry_manager(
        ...
        logger.info("Mapper retry manager '%s' created", name)
    ...
    def reset_all(self):
        ...
        for cb in self._circuit_breakers.values():
            cb.reset()
        logger.info("All mapper circuit breakers reset")
