...
def generate_advanced_training_data(
    ...
    if include_legal_reasoning:
        legal_examples = generator.generate_legal_reasoning_examples(total_examples // 6)
    ...
    for example in all_examples:
        ...
        stats["reasoning_types"][reasoning_type] = stats["reasoning_types"].get(reasoning_type, 0) + 1
