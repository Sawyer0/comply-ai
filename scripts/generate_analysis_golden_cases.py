...
def generate_analysis_golden_cases() -> Dict[str, Any]:
    ...
    return {
        ...
        "metadata": {
            ...
            "test_categories": {
                "single_analysis": len(
                    [c for c in test_cases if "single_analysis" in c["id"]]
                ),
                "batch_analysis": len(
                    [c for c in test_cases if "batch_analysis" in c["id"]]
                ),
        ...
        case = {
            ...
            "request": {
                ...
                "body": {
                    ...
                    "high_sev_hits": [],
                    "false_positive_bands": [
                        {"detector": "detector1", "fp_rate": scenario["fp_rate"]}
                    ],
                    "policy_bundle": "soc2-v1.0",
                    "env": "prod",
                },
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate Analysis Module golden test cases"
    )
    parser.add_argument(
        "-o",
        "--output",
