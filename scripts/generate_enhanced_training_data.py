...
def generate_hybrid_training_data(
    ...
    taxonomy_loader = TaxonomyLoader(taxonomy_path=".kiro/pillars-detectors/taxonomy.yaml")
    ...
    examples = hybrid_generator.generate_hybrid_training_set(
        ...
        real_world_categories=["sec", "gdpr", "hipaa", "industries", "edge_cases"] if include_edge_cases else ["sec", "gdpr", "hipaa", "industries"],
...
def main():
    ...
    try:
        ...
        logger.info("Real-world ratio: %.2f", stats["data_quality_metrics"]["real_world_ratio"])
        logger.info("Synthetic ratio: %.2f", stats["data_quality_metrics"]["synthetic_ratio"])
        logger.info("Edge case ratio: %.2f", stats["data_quality_metrics"]["edge_case_ratio"])
        logger.info("Multi-category ratio: %.2f", stats["data_quality_metrics"]["multi_category_ratio"])
